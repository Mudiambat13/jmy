              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Avenue des Constructeurs<br />75001 Paris, France</p>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className={`w-full bg-primary hover:bg-primary-light text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300 ${
